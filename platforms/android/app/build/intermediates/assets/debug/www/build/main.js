...
var FormKelembagaanPage = /** @class */ (function () {
    function FormKelembagaanPage(params, viewCtrl, authService, loadingCtrl, toastCtrl, geolocation, locationAccuracy) {
        var _this = this;
        this.params = params;
        this.viewCtrl = viewCtrl;
        this.authService = authService;
